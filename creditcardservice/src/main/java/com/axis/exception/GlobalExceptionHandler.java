...
public class GlobalExceptionHandler {
	...
	ResponseEntity<ErrorInfo> myExceptionResponse(CardNumberNotFoundException exception)
	{
		ErrorInfo errorInfo = new ErrorInfo();
		errorInfo.setStatus(HttpStatus.NOT_FOUND.toString());
		errorInfo.setErrorMessage(exception.getErrorMsg());
	...
	ResponseEntity<ErrorInfo> myExceptionResponse(CardStatusException exception)
	{
		ErrorInfo errorInfo = new ErrorInfo();
		errorInfo.setStatus(HttpStatus.NOT_FOUND.toString());
		errorInfo.setErrorMessage(exception.getErrorMsg());
